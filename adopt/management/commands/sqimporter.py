    ...
    def handle(self, *args, **options):
        ...
        with open(filename) as f:
            ...
            for item in reader:
                ...
                squirrelTest = SquirrelTest.objects.create_squirrelTest(x, y, squirrel_id, hectare, shift, date, hectare_sq, age, primary_fur, highlight_fur,
                        combi_fur, color_note, location, above_ground, spec_loc, running, chasing, climbing, eating, foraging, other_act, kuks, quaas, moans, flags, twitches, approaches,
                       indifferent, runsfrom, other_int, lat_long)
                squirrelTest.save()

                self.stdout.write(self.style.SUCCESS('Successfully created squirrel "%s"' % squirrel_id))
