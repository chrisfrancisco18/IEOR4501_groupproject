...
class Command(BaseCommand):
    ...
    def squirrel_to_dict(self, squirrel):
        return {'X': squirrel.x, 'Y': squirrel.y, 'Unique Squirrel ID': squirrel.unique_squirrel_id,'Hectare': squirrel.hectare,
                ...
                'Primary Fur Color':squirrel.primary_fur, 'Highlight Fur Color': squirrel.highlight_fur, 'Combination of Primary and Highlight Color': squirrel.combi_fur, 'Color notes':squirrel.color_note, 'Location':squirrel.location, 'Above Ground Sighter Measurement':squirrel.above_ground, 'Specific Location':squirrel.spec_loc, 'Running':squirrel.running, 'Chasing':squirrel.chasing,
                ,'Climbing':squirrel.climbing, 'Eating':squirrel.eating, 'Foraging':squirrel.foraging, 'Other Activities': squirrel.other_act, 'Kuks':squirrel.kuks, 'Quaas':squirrel.quaas, 'Moans':squirrel.moans, 'Tail flags':squirrel.flags, 'Tail twitches':squirrel.twitches, 'Approaches':squirrel.approaches, 'Indifferent':squirrel.indifferent, 'Runs from': squirrel.runsfrom, 'Other Interactions':squirrel.other_int, 'Lat/Long':squirrel.lat_long 
